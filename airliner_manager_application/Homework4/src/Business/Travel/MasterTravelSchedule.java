...
public class MasterTravelSchedule {
    ...
    private Map<String, List<Flight>> sortedFlightList;  //key value for airline based selection
    
    public MasterTravelSchedule(){
        this.totalFlights = new ArrayList();
        this.sortedFlightList = new HashMap();
    ...
    public void loadAllflights(){
        for(Airliner airliner : this.ta.getAirlinerDirectory().getLstAirliner()){
            ...
            sortedFlightList.put(airliner.getAirlinerName(), currentFlights);
        }
    }
    ...
    public Map<String, List<Flight>> getSortedFlightList() {
        return sortedFlightList;
    }

    public void setSortedFlightList(Map<String, List<Flight>> sortedFlightList) {
        this.sortedFlightList = sortedFlightList;
    }
}
